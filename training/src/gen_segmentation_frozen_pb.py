...
parser.add_argument('--output_node_names', type=str, default='conv2d/BiasAdd')
...
with tf.Session() as sess:
    ...
    prediction = resnet_18_seg(input_node, is_training=False)
    ...
    tf.train.write_graph(output_graph_def, "./", 'graph_eval.pbtxt', as_text=True)
